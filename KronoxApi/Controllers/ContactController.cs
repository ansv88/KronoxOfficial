...
/// <summary>
/// API‑kontroller för kontaktsidan: skickar kontaktformulär (e‑post), hämtar kontaktinfo,
/// samt Admin‑CRUD för kontaktpersoner, postadress och e‑postlistor.
/// Blandad åtkomst: publika GET:ar och Admin-skyddade uppdateringar.
/// </summary>
...
public class ContactController : ControllerBase
{
    ...
    public async Task<IActionResult> SendContactMessage([FromBody] ContactFormDto contactForm)
    {
        ...
        try
        {
            ...
            _logger.LogDebug("Kontaktmeddelande skickat från {Email} med ämne '{Subject}'",
