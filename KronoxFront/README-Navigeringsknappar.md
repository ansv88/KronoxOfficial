...
## Se även
- Samlad översikt av all appsettings‑konfiguration (inkl. `Redirects` och `NewsSettings`): se [`README.md`](README.md) → avsnittet "Konfiguration (appsettings)".
- Notera att appen behöver **startas om** efter ändringar (konfigurationen läses vid uppstart).
